<div>
    ...
    <div class="hidden border-r-2 md:block" id="menu">
        ...
        <nav class="border-gray-700">
            <a href="{{ route('admin.dashboard') }}" class="block px-4 py-2 font-semibold text-white rounded-md shadow-xl">
                <span class="flex">
            ...
            <a href="" class="block px-4 py-2 font-semibold text-white rounded-md shadow-xl">
                <span class="flex">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mr-2">
