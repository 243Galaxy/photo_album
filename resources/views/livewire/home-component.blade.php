    ...
    <main class="mb-40 space-y-40">
        ...
        <div class="relative ml-auto pt-36">
                <div class="mx-auto text-center lg:w-2/3">
                    <h1 class="text-5xl font-bold text-gray-900 dark:text-white md:text-6xl xl:text-7xl">CODOBA <span class="text-primary dark:text-white">1998.</span></h1>
                    ...
                    <div class="flex flex-wrap justify-center mt-16 gap-y-4 gap-x-6">
                        <a href="#" class="relative flex items-center justify-center w-full px-6 h-11 before:absolute before:inset-0 before:rounded-full before:bg-primary before:transition before:duration-300 hover:before:scale-105 active:duration-75 active:before:scale-95 sm:w-max">
                          <span class="relative text-base font-semibold text-white">Register</span>
                        </a>
                    ...
                    <div class="justify-center hidden py-8 mt-16 border-gray-100 border-y dark:border-gray-800 sm:flex">
                        <div class="text-left">
                            <h6 class="text-lg font-semibold text-gray-700 dark:text-white">MOTTO:</h6>
                            <p class="mt-2 text-gray-400">
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempore laboriosam nobis recusandae dolor praesentium accusamus eum similique repellendus eos impedit vero quaerat ab, id, distinctio laborum fugiat esse. Quod, alias?
                            </p>
                        </div>
                    </div>
                </div>
                <div class="grid grid-cols-3 mt-12 sm:grid-cols-4 md:grid-cols-6">
                    <div class="p-4 transition duration-200 grayscale hover:grayscale-0">
                        <img src="{{ asset('imgs/1.png') }}" class="w-auto h-64 mx-auto rounded-md" loading="lazy" alt="client logo" width="" height="">
                      </div>
                    <div class="p-4 transition duration-200 grayscale hover:grayscale-0">
                      <img src="{{ asset('imgs/2.png') }}" class="w-auto h-64 mx-auto rounded-md" loading="lazy" alt="client logo" width="" height="">
                    </div>
                    <div class="flex p-4 transition duration-200 grayscale hover:grayscale-0">
                      <img src="{{ asset('imgs/3.png') }}" class="w-auto h-64 m-auto rounded-md" loading="lazy" alt="client logo" width="" height="">
                    </div>
                    <div class="p-4 transition duration-200 grayscale hover:grayscale-0">
                        <img src="{{ asset('imgs/4.png') }}" class="w-auto h-64 mx-auto rounded-md" loading="lazy" alt="client logo" width="" height="">
                      </div>
                      <div class="flex p-4 transition duration-200 grayscale hover:grayscale-0">
                        <img src="{{ asset('imgs/5.png') }}" class="w-auto h-64 m-auto rounded-md" loading="lazy" alt="client logo" width="" height="">
                      </div>
                    <div class="p-4 transition duration-200 grayscale hover:grayscale-0">
                        <img src="{{ asset('imgs/6.png') }}" class="w-auto h-64 mx-auto rounded-md" loading="lazy" alt="client logo" width="" height="">
                    </div>
                  </div>
            </div>
        </div>
          ...
          <div class="px-6 mx-auto max-w-7xl md:px-12 xl:px-6">
            <div class="md:w-2/3 lg:w-1/2">
            ...
            </div><div class="grid mt-16 overflow-hidden text-gray-600 border border-gray-100 divide-x divide-y divide-gray-100 dark:divide-gray-700 rounded-3xl dark:border-gray-700 sm:grid-cols-2 lg:grid-cols-4 lg:divide-y-0 xl:grid-cols-4">
              <div class="group relative bg-white dark:bg-gray-800 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10">
                <div class="relative p-8 py-12 space-y-8">
                  <img src="{{ asset('imgs/5.png') }}" class="w-12" width="512" height="512" alt="burger illustration">
      
                  <div class="space-y-2">
                    <h5 class="text-xl font-semibold text-gray-700 transition dark:text-white group-hover:text-secondary">
                      First feature
                    </h5>
                  ...
                  <a href="#" class="flex items-center justify-between group-hover:text-secondary">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-5 h-5 text-2xl transition duration-300 -translate-x-4 opacity-0 group-hover:translate-x-0 group-hover:opacity-100">
              ...
              <div class="group relative bg-gray-50 dark:bg-gray-900 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10">
                <div class="relative p-8 py-12 space-y-8 transition duration-300 group-hover:bg-white dark:group-hover:bg-gray-800">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6 text-sky-500">
              ...
              </svg><div class="flex-row-reverse justify-between space-y-6 text-gray-600 md:flex md:gap-6 md:space-y-0 lg:gap-12 lg:items-center">
                ...
                <div class="md:7/12 lg:w-1/2">
                  ...
                  <div class="space-y-4 divide-y divide-gray-100 dark:divide-gray-800">
                    <div class="flex gap-4 mt-8 md:items-center">
                      ...
                      <div class="w-5/6">
                        <h4 class="text-lg font-semibold text-gray-700 dark:text-indigo-300">Chat Anytime</h4>
                    ...
                    <div class="flex gap-4 pt-4 md:items-center">
                      ...
                      <div class="w-5/6">
                        <h4 class="text-lg font-semibold text-gray-700 dark:text-teal-300">Real Time Location</h4>
                        <p class="text-gray-500 dark:text-gray-400">Asperiores nemo possimus nesciunt quam mollitia.</p>
                      </div> 
                    </div> 
                  </div>
          ...
          <div class="px-6 mx-auto max-w-7xl md:px-12 xl:px-6">
            ...
            </div><div class="gap-8 space-y-8 md:columns-2 lg:columns-3">
          ...
          <div aria-hidden="true" class="absolute inset-0 grid w-full grid-cols-2 m-auto h-max -space-x-52 opacity-40 dark:opacity-20">
            <div class="blur-[106px] h-56 bg-gradient-to-br from-primary to-purple-400 dark:from-blue-700"></div>
            <div class="blur-[106px] h-32 bg-gradient-to-r from-cyan-400 to-sky-300 dark:to-indigo-600"></div>
          </div>
          <div class="px-6 mx-auto max-w-7xl md:px-12 xl:px-6">
            <div class="relative">
              <div class="flex items-center justify-center -space-x-2">
                <img loading="lazy" width="220" height="220" src="https://pbs.twimg.com/profile_images/1559671811780087810/Y4E8X2do_400x400.jpg" alt="member photo" class="object-cover w-8 h-8 rounded-full">
                <img loading="lazy" width="220" height="220" src="https://pbs.twimg.com/profile_images/1511686703672606725/_DV4Mfjd_400x400.jpg" alt="member photo" class="object-cover w-12 h-12 rounded-full">
                <img loading="lazy" width="220" height="220" src="https://pbs.twimg.com/profile_images/1372441824560771075/DTcuXT0Z_400x400.jpg" alt="member photo" class="z-10 object-cover w-16 h-16 rounded-full">
                <img loading="lazy" width="220" height="220" src="https://pbs.twimg.com/profile_images/1362367807887974401/kuJ1OFT1_400x400.jpg" alt="member photo" class="relative object-cover w-12 h-12 rounded-full">
                <img loading="lazy" width="220" height="220" src="https://pbs.twimg.com/profile_images/1398547148086681604/ctgizwrN_400x400.jpg" alt="member photo" class="object-cover w-8 h-8 rounded-full">
              </div>
              <div class="m-auto space-y-6 md:w-8/12 lg:w-7/12">
                <h1 class="text-4xl font-bold text-center text-gray-800 dark:text-white md:text-5xl">Get Started now</h1>
                ...
                <div class="flex flex-wrap justify-center gap-6">
                  <a href="#" class="relative flex items-center justify-center w-full h-12 px-8 before:absolute before:inset-0 before:rounded-full before:bg-primary before:transition before:duration-300 hover:before:scale-105 active:duration-75 active:before:scale-95 sm:w-max">
          ...
          <div class="px-6 mx-auto max-w-7xl md:px-12 xl:px-6">
            <div class="mb-12 space-y-2 text-center">
                ...
                <div class="p-6 bg-white bg-opacity-50 border border-gray-100 shadow-2xl group sm:p-8 rounded-3xl dark:shadow-none dark:border-gray-700 dark:bg-gray-800 shadow-gray-600/10">
                  <div class="relative overflow-hidden rounded-xl">
                    <img src="https://images.unsplash.com/photo-1661749711934-492cd19a25c3?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1674&q=80" alt="art cover" loading="lazy" width="1000" height="667" class="object-cover object-top w-full h-64 transition duration-500 group-hover:scale-105">
                  </div>
                ...
                <div class="p-6 bg-white bg-opacity-50 border border-gray-100 shadow-2xl group sm:p-8 rounded-3xl dark:shadow-none dark:border-gray-700 dark:bg-gray-800 shadow-gray-600/10">
                  <div class="relative overflow-hidden rounded-xl">
                    <img src="https://images.unsplash.com/photo-1620121692029-d088224ddc74?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2832&q=80" alt="art cover" loading="lazy" width="1000" height="667" class="object-cover object-top w-full h-64 transition duration-500 group-hover:scale-105">
                  </div>
                  <div class="relative mt-6">
                    <h3 class="text-2xl font-semibold text-gray-800 dark:text-white">
                      De fuga fugiat lorem ispum laboriosam expedita.
